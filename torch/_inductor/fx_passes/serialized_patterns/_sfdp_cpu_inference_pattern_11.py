...
_sfdp_cpu_inference_pattern_11 = CallFunction(aten.view.default, bmm_default_1, Ignored())
...
view_default_4 = CallFunction(aten.view.default, clone_default_2, Ignored())
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
_sfdp_cpu_inference_pattern_11_bfloat16 = CallFunction(aten.view.default, bmm_default_1, Ignored())
